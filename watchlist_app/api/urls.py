...
urlpatterns = [
    ...
    # path('stream/<int:pk>/review/', StreamPlatformDetailAV.as_view(), name='platform-detail'),
    # path('stream/review/<int:pk>/', StreamPlatformDetailAV.as_view(), name='platform-detail'),
